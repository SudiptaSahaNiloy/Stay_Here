...
const mapDispatchToProps = (dispatch) => {
    return {
        guest: (firstName, lastName, phoneNumber, email) => dispatch(guest(firstName, lastName, phoneNumber, email))
    }
}
                ...
                <div className="row">
                    ...
                    <div className="col-md-6">
                        <Formik
                            ...
                            onSubmit={
                                (values) => {
                                    this.props.guest(values.firstName, values.lastName, values.phoneNumber, values.email);
                                }
                            }
